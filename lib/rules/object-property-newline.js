module.exports = {
    ...
    schema: [
      {
        type: 'object',
        properties: {
          allowMultiplePropertiesPerLine: {type: 'boolean'},
          applyToDestructuring: {type: 'boolean'},
        },
  ...
  create(context) {
    ...
    return {
      ...
      ObjectPattern(node) {
        const errorMessage = allowSameLine
          ? "Destructured properties must go on a new line if they aren't all on the same line."
          : 'Destructured properties must go on a new line.';
